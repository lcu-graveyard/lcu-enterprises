...
import { EntDemoForgeBuildersService } from "./svc/builders.service";
import { EntDemoForgeSolutionsService } from "./svc/solutions.service";
...
var fathymServices = [
  { provide: IBuildersService, useClass: EntDemoForgeBuildersService },
  { provide: ISolutionsService, useClass: EntDemoForgeSolutionsService }
];
